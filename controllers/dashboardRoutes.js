...
router.get("/", async (req, res) => {
    try {
        ...
        console.log(posts)
        res.render('newpost', {layout:"main", posts, loggedIn: req.session.loggedIn });
    } catch (err) {
...
// insert new post
router.post("/post", authorHere, async (req, res) => {
    try {
...
// update a post by id
router.put("/post/:id",authorHere, async (req, res) => {
    try {
...
// delete a post by id
router.delete("/post/:id",authorHere, async (req, res) => {
    try {
...
router.get("/post/:id",authorHere, async (req, res) => {
    try {
